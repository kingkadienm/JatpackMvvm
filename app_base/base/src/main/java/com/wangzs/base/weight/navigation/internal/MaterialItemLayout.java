package com.wangzs.base.weight.navigation.internal;
...
import com.wangzs.base.weight.navigation.ItemController;
import com.wangzs.base.weight.navigation.MaterialMode;
        ...
        if ((mode & MaterialMode.CHANGE_BACKGROUND_COLOR) > 0) {
            ...
            for (int i = 0; i < mItems.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    v.setBackgroundResource(R.drawable.tabstrip_material_item_background);
                }
            }
        }
