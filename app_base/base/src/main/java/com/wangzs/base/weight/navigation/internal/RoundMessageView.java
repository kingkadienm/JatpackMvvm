...
public class RoundMessageView extends FrameLayout {
    ...
    public RoundMessageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.tabstrip_round_message_view, this, true);
    ...
    public void tintMessageBackground(@ColorInt int color) {
        Drawable drawable = ColorUtil.tinting(ContextCompat.getDrawable(getContext(),
                R.drawable.tabstrip_round), color);
