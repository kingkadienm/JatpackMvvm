...
import com.wangzs.base.weight.navigation.listener.SimpleTabItemSelectedListener;
...
public class NavigationController implements ItemController, BottomLayoutController {
    ...
    protected NavigationController(BottomLayoutController bottomLayoutController,
    ...
    @Override
    public void addMaterialItem(int index, @NonNull Drawable defaultDrawable,
                                @NonNull Drawable selectedDrawable, @NonNull String title,
                                int selectedColor) {
        mItemController.addMaterialItem(index, ColorUtil.newDrawable(defaultDrawable),
                ColorUtil.newDrawable(selectedDrawable), title, selectedColor);
    }
