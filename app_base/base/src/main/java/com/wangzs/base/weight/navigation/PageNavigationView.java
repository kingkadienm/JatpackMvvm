package com.wangzs.base.weight.navigation;
...
import com.wangzs.base.weight.ColorUtil;
import com.wangzs.base.weight.navigation.internal.CustomItemLayout;
import com.wangzs.base.weight.navigation.internal.CustomItemVerticalLayout;
import com.wangzs.base.weight.navigation.internal.MaterialItemLayout;
import com.wangzs.base.weight.navigation.internal.MaterialItemVerticalLayout;
import com.wangzs.base.weight.navigation.item.BaseTabItem;
import com.wangzs.base.weight.navigation.item.MaterialItemView;
import com.wangzs.base.weight.navigation.item.OnlyIconMaterialItemView;
...
public class PageNavigationView extends ViewGroup {
    ...
    public class MaterialBuilder {
        ...
        public MaterialBuilder addItem(@DrawableRes int drawableRes, @NonNull String title) {
            addItem(drawableRes, drawableRes, title, ColorUtil.getColorPrimary(getContext()));
        ...
        public MaterialBuilder addItem(@DrawableRes int drawableRes, @DrawableRes int checkedDrawableRes, @NonNull String title) {
            addItem(drawableRes, checkedDrawableRes, title, ColorUtil.getColorPrimary(getContext()));
            return MaterialBuilder.this;
        }
        ...
        public MaterialBuilder addItem(@NonNull Drawable drawable, @NonNull String title) {
            addItem(drawable, drawable, title, ColorUtil.getColorPrimary(getContext()));
            return MaterialBuilder.this;
        }
        ...
        public MaterialBuilder addItem(@NonNull Drawable drawable, @NonNull Drawable checkedDrawable, @NonNull String title) {
            addItem(drawable, checkedDrawable, title, ColorUtil.getColorPrimary(getContext()));
            return MaterialBuilder.this;
        }
        ...
        public MaterialBuilder addItem(@NonNull Drawable drawable, @NonNull Drawable checkedDrawable, @NonNull String title, @ColorInt int chekedColor) {
            ...
            data.drawable = ColorUtil.newDrawable(drawable);
            data.checkedDrawable = ColorUtil.newDrawable(checkedDrawable);
            data.title = title;
