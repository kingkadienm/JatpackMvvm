...
public class ClassUtils {
    ...
    getObjectsWithInterface(Context context, Class<T> clazz, String... paths) {
    ...
    public static List<String> getFileNameByPackageName(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException {
        ...
        for (String path : getSourcePaths(context)) {
            ...
            try {
                ...
                LogUtil.e("Scan map file in dex files made error." + ignore);
            } finally {
                if (null != dexfile) {
                    try {
                        dexfile.close();
        ...
        LogUtil.i("Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            LogUtil.i("Found InstantRun support");
        } else {
            try {
                ...
                LogUtil.i("InstantRun support error, " + e.getMessage());
            }
        }
